...
const SEEDS = {
  ...
  purchases: [],
  themes: [
    { name: '默认（亮色）', authorId: null, isDefault: true, css: '' },
    {
      name: '暗色', authorId: null, isDefault: false,
      css: `:root { --blue:#4f8cff; --head:#0d1420; --text:#cfe0f5; --muted:#7d93a8; --line:#1d2c49; --hover:#141f36; }
